...
public class BlockStableLiquidMire extends BlockFluidClassic {
  ...
  public BlockStableLiquidMire(int mopc, int lopc, int iopc) {
    super(MFQM.MireFluidS, Material.water);
    setQuantaPerBlock(8);
    if (MFQM.QSOpacity) {
      setLightOpacity(16);
    } else {
    ...
    setUnlocalizedName("SLiquidMire");
    setRenderPass(0);
