...
public class EntityTarSlime extends EntityLiving implements IMob {
  ...
  public EntityTarSlime(World p_i1742_1_) {
    super(p_i1742_1_);
    this.yOffset = 0.0F;
  ...
  protected EntityTarSlime createInstance() {
  ...
  public void onUpdate() {
    ...
    if (this.onGround && !var1) {
      ...
      for (int var3 = 0; var3 < var2 * 16; var3++) {
        ...
        this.worldObj.spawnParticle("blockcrack_" + Block.getIdFromBlock(MFQM.TarBlock) + "_" + Character.MIN_VALUE, this.posX + var6, this.boundingBox.minY, this.posZ + var7, 0.0D, 0.0D, 0.0D);
      } 
      if (makesSoundOnLand())
    ...
    if (this.riddenByEntity == null) {
      ...
      if (!this.worldObj.isRemote) {
        ...
        ((EntityLivingBase)this.riddenByEntity).addPotionEffect(new PotionEffect(4, 100, 20, false));
        ((EntityLivingBase)this.riddenByEntity).addPotionEffect(new PotionEffect(18, 100, 20, false));
        ((EntityLivingBase)this.riddenByEntity).addPotionEffect(new PotionEffect(4, 200, 3, false));
        ((EntityLivingBase)this.riddenByEntity).addPotionEffect(new PotionEffect(18, 200, 3, false));
        ((EntityLivingBase)this.riddenByEntity).addPotionEffect(new PotionEffect(2, 200, 3, false));
        if (this.riddenByEntity.posY > this.posY + 0.25D)
          checkPlayerMuddy((EntityPlayer)this.riddenByEntity, 0.0D, this.posY + getMountedYOffset() - 0.5D - 0.25D, 0.0D, this.worldObj); 
      } 
      if (this.worldObj.getTotalWorldTime() % 6L == 0L && 
      ...
      if (this.deepFactor < 12.5F) {
        ...
        if (this.pullTime-- <= 0.0F) {
          this.pullTime = (55 + this.rand.nextInt(10));
          this.squishAmount = 1.5F;
          this.TdeepFactor += 1.5F;
        ...
        this.worldObj.getTotalWorldTime() % 2L == 0L && this.rand.nextInt(5) == 0) {
  ...
  public void checkPlayerMuddy(EntityPlayer ent, double x, double y, double z, World world) {
    ...
    if (!world.isRemote) {
      ...
      if (preML > props.getMuddyLevel() * props.getMuddyTime() / 1000.0F) {
        ...
        int mdtp = MFQM.getMuddyType(MFQM.TarBlock);
        props.setMuddyType(mdtp);
        if (props.getMuddyTime() < 10000)
          props.addMuddyTime(500); 
        ...
        if (canEntityBeSeen((Entity)p_70100_1_) && getDistanceSqToEntity((Entity)p_70100_1_) < var2 * sizeCoof) {
          ...
          if (inv) {
            if (!isInsideOfMaterial(Material.water)) {
              float hp = p_70100_1_.getHealth() / opMul / 6.0F;
            ...
            if (!this.worldObj.isRemote) {
              p_70100_1_.addPotionEffect(new PotionEffect(2, 50, 5, false));
              p_70100_1_.addPotionEffect(new PotionEffect(4, 100, 2, false));
              p_70100_1_.addPotionEffect(new PotionEffect(18, 100, 2, false));
  ...
  public boolean attackEntityFrom(DamageSource dmgs, float power) {
    ...
    if (ply != null && 
      ...
      if (ent == ply && ply.isEntityAlive() && ply.distanceWalkedModified > 0.0F) {
        ...
        if (!Weapon) {
          if (!this.worldObj.isRemote) {
            ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(2, 200, 5, false));
            ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(4, 200, 10, false));
            ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(18, 200, 10, false));
            checkPlayerMuddy((EntityPlayer)ply, 0.0D, ply.posY - 0.25D, 0.0D, this.worldObj);
            checkPlayerMuddy((EntityPlayer)ply, 0.0D, ply.posY - 0.25D, 0.0D, this.worldObj);
            Stopper = true;
          ...
          float opMul = Math.max(getMaxHealth() / 30.0F, 1.0F);
          ...
          if (canStuck) {
            if (power < 3.0F * opMul)
              for (int i = 0; i < this.inv.length; i++) {
                if (this.inv[i] == null) {
                  ...
                  enablePersistence();
                  ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(2, 100, 5, false));
                  ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(4, 100, 10, false));
                  ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(18, 100, 10, false));
                  checkPlayerMuddy((EntityPlayer)ply, 0.0D, ply.posY - 0.25D, 0.0D, this.worldObj);
                  checkPlayerMuddy((EntityPlayer)ply, 0.0D, ply.posY - 0.25D, 0.0D, this.worldObj);
                  Stopper = true;
                  ((EntityLivingBase)ply).setInWeb();
            ...
            ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(4, 100 + Math.max(slowLevel * 20, 0), Math.min(slowLevel + 4, 10), false));
            ((EntityLivingBase)ply).addPotionEffect(new PotionEffect(18, 100 + Math.max(weakLevel * 20, 0), Math.min(weakLevel + 4, 10), false));
            checkPlayerMuddy((EntityPlayer)ply, 0.0D, ply.posY - 0.25D, 0.0D, this.worldObj);
          } 
        } 
      } 
  ...
  protected void dropFewItems(boolean par1, int par2) {
    ...
    for (var4 = 0; var4 < var3; var4++)
      entityDropItem(new ItemStack(Items.coal, 1, 0), 0.0F); 
    if (!this.worldObj.isRemote)
      for (int i = 0; i < this.inv.length; i++) {
        if (this.inv[i] != null)
  ...
  public boolean getCanSpawnHere() {
    ...
    if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
      ...
      int yyy = 0;
      int zzz = 0;
      int xx = MathHelper.floor_double(this.posX) - 16;
      int yy = MathHelper.floor_double(this.posY) - 8;
      int zz = MathHelper.floor_double(this.posZ) - 16;
      for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
          for (int h = 0; h < 3; h++) {
            xxx = xx - 16 + 16 * i;
            ...
            zzz = zz - 16 + 16 * j;
            for (int g = 0; g < 5; g++) {
              if (this.worldObj.getBlock(xxx + this.rand.nextInt(9) - 4, yyy + this.rand.nextInt(5) - 2, zzz + this.rand.nextInt(9) - 4) == MFQM.TarBlock)
